...
# # MODEL_DIR = "/app/models/indictrans2-ct2"
# # SP_MODEL_PATH = f"{MODEL_DIR}/sentencepiece.model"
...
# # def download_model():
# #     """Download the CTranslate2-converted IndicTrans2 model"""
# #     if os.path.exists(MODEL_DIR) and os.path.exists(f"{MODEL_DIR}/model.bin"):
# #         logger.info("Model already downloaded and ready.")
# #         return

# #     os.makedirs(MODEL_DIR, exist_ok=True)
    
# #     logger.info("Downloading IndicTrans2 CTranslate2 model from HuggingFace...")
    
# #     try:
# #         # Use the CT2-converted model which is publicly available
# #         snapshot_download(
# #             repo_id="ai4bharat/indictrans2-indic-en-1B-ct2",  # CTranslate2 version
# #             local_dir=MODEL_DIR,
# #             local_dir_use_symlinks=False,
...
# #         if not os.path.exists(f"{MODEL_DIR}/model.bin"):
...
# #         # Fallback: Try the public version or alternative repo
# #         try:
# #             snapshot_download(
# #                 repo_id="ai4bharat/indictrans2-en-indic-1B-ct2",  # Alternative
# #                 local_dir=MODEL_DIR,
# #                 local_dir_use_symlinks=False,
# #                 resume_download=True,
# #                 ignore_patterns=["*.md", "*.txt", ".gitattributes"]
...
# #             raise RuntimeError(
# #                 "Could not download model. Please check:\n"
# #                 "1. Your HF_TOKEN has access to the model\n"
# #                 "2. Request access at https://huggingface.co/ai4bharat/indictrans2-indic-en-1B\n"
# #                 "3. Or use a public alternative model"
# #             )
...
# #     if not sp_processor:
# #         logger.info("Loading SentencePiece model...")
# #         # Try different possible names for the SP model
# #         sp_paths = [
# #             SP_MODEL_PATH,
# #             f"{MODEL_DIR}/spm.model",
# #             f"{MODEL_DIR}/source.spm",
# #             f"{MODEL_DIR}/vocab.spm"
# #         ]
        
# #         sp_loaded = False
# #         for sp_path in sp_paths:
# #             if os.path.exists(sp_path):
# #                 sp_processor = spm.SentencePieceProcessor(sp_path)
# #                 sp_loaded = True
# #                 logger.info(f"Loaded SentencePiece from {sp_path}")
# #                 break
        
# #         if not sp_loaded:
# #             raise FileNotFoundError(
# #                 f"SentencePiece model not found. Tried: {sp_paths}"
# #             )
...
# #         # Add language tags
# #         input_tokens = [src_lang] + tokenized
...
# MODEL_NAME = "facebook/nllb-200-distilled-600M"  # Public, no auth required
# model = None
# tokenizer = None
...
#         if not model:
#             logger.warning("Model not initialized, returning original text")
#             return TranslateResponse(translatedText=req.q)
...
#         inputs = tokenizer(req.q, return_tensors="pt", padding=True, truncation=True, max_length=512)
...
#         return TranslateResponse(translatedText=translation)
